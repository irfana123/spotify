...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 11 17:13:06 2021
...
def predict():
    ...
    output = [' Skip', 'Not Skip']

    return render_template('result.html', prediction_text= 'Prediction: Probably user will "{}" this Music track.'.format(output[int(prediction)]))
